    ...
    el.innerHTML = `
      <div style="display:flex;align-items:center;justify-content:center;min-height:60vh">
        <div style="background:#fff;border-radius:12px;box-shadow:0 4px 24px rgba(0,0,0,.10);padding:48px 56px;max-width:520px;width:100%;text-align:center">
          ...
          <h2 style="margin:0 0 8px;font-size:22px">Informes</h2>
          ...
          <ul style="text-align:left;color:#555;line-height:1.8;margin:0 0 24px;padding-left:20px">
            <li>Ventas por producto (período, sucursal, categoría)</li>
            <li>Ventas por vendedor y cálculo de comisiones</li>
            <li>Historial de cuenta corriente por cliente</li>
            <li>Stock actual vs. mínimo por sucursal</li>
            <li>Productos bajo alerta de reposición</li>
            <li>Compras del período por proveedor</li>
            <li>Cierre de caja por fecha y sucursal</li>
            <li>Rentabilidad: costo vs. precio de venta</li>
          </ul>
