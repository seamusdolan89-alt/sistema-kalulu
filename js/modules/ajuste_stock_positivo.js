/**
 * ajuste_stock_positivo.js - Ajuste de stock (ingreso)
 *
 * Para cuando el recuento da MAS de lo que dice el sistema. El hermano de
 * ajuste_stock.js, que descuenta.
 *
 * Dos diferencias que no son cosmeticas:
 *  - No escribe en consumo_interno. Esa tabla registra salidas (consumo,
 *    rotura, vencimiento); meter un ingreso ahi ensuciaria los informes.
 *    Solo deja el movimiento en stock_ajustes, igual que hacen las
 *    devoluciones del POS.
 *  - No valida contra el stock disponible: sumar no depende de lo que haya.
 */
import Buscador from './buscador_productos.js';
'use strict';

const AjusteStockPositivo = (() => {
    ...
    if (!cart.length) {
      tbody.innerHTML = `<tr><td colspan="6">
        <div class="ci-cart-empty">
          ...
          Buscá los productos a los que les falta stock en el sistema
        </div>
      </td></tr>`;
...
export default AjusteStockPositivo;
