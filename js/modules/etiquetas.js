    ...
    el.innerHTML = `
      <div style="display:flex;align-items:center;justify-content:center;min-height:60vh">
        <div style="background:#fff;border-radius:12px;box-shadow:0 4px 24px rgba(0,0,0,.10);padding:48px 56px;max-width:520px;width:100%;text-align:center">
          ...
          <h2 style="margin:0 0 8px;font-size:22px">Etiquetas de Precio</h2>
          ...
          <ul style="text-align:left;color:#555;line-height:1.8;margin:0 0 24px;padding-left:20px">
            <li>Diseño de etiqueta configurable (tamaño y campos)</li>
            <li>Impresión en hoja A4 (grilla de etiquetas)</li>
            <li>Selección de múltiples productos para lote</li>
            <li>Campos: nombre, precio, código de barras, fecha</li>
            <li>Disparo automático al actualizar precios desde Compras</li>
          </ul>
