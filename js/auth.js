...
(function() {
  ...
  window.SGA_PERMISOS_DEF = [
    ...
    // Los dos ajustes van en riesgo alto y apagados: mueven stock sin respaldo
    // de una venta, una compra, una rotura ni un vencimiento. El de egreso se
    // presta a tapar un faltante; el de ingreso, a inventar mercaderia que
    // despues figura como vendible. Solo el rol admin los tiene sin habilitar
    // nada, porque pasa por encima de los permisos.
    { key: 'can_ajuste_stock',         label: 'Ajustar stock — egreso (descontar)',        grupo: 'Stock', riesgo: 'alto',  tipo: 'bool', default: false },
    { key: 'can_ajuste_stock_positivo', label: 'Ajustar stock — ingreso (sumar)',          grupo: 'Stock', riesgo: 'alto',  tipo: 'bool', default: false },
